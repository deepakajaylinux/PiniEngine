...
필수 매개변수
---------------------------------------
사용자 매크로를 선언할 때 기본 매개변수를 지정해 줄 수 있습니다. 기본 매개변수란 필수 매개변수와는 반대되는 개념입니다.
즉, 어떠한 매크로가 기본 매개변수를 가지고 있다면 그 매크로를 호출할때 전달 해주어야 하는 최소한의 매개변수는 필수 매개변수
...
문자열 변수의 병합
---------------------------------------
덧셈(+) 기호를 사용하여 문자열 변수와 다른 문자열 혹은 다른 문자열 변수와 병합할 수 있습니다. 
