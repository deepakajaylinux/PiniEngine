...
1. 모바일 기기가 PC에 USB로 연결되어 있어야 합니다.
2. 연결된 모바일 기기에 맞는 USB드라이버가 PC에 설치되어 있어야 합니다.
3. 모바일 기기의 설정 앱에서 개발자 옵션이 켜져 있어야 합니다. 안드로이드의 경우 폰마다 개발자 옵션을 켜는 방법이 다를 수 있으니 인터넷에서 해당 기기의 개발자 옵션을 켜는 부분이 어디있는지 찾아 보시길 바랍니다.
