...
.. raw:: html
    ...
    <script>
        ...
        document.getElementByName("text-example1").setAttribute("data-clipboard-text",code);
    </script>
...
.. raw:: html
    ...
    <script>
        ...
        document.getElementByName("text-example2").setAttribute("data-clipboard-text",code);
    </script>
